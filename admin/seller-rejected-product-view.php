...
if (isset($_POST['export_csv'])) {
    ...
    $query = "SELECT
            ...
            WHERE t1.seller_id = ? AND t1.p_is_approve = 0";
    ...
    try {
        ...
        header('Content-Disposition: attachment; filename="rejected_products.csv"');
			...
			<div class="box box-info">
              ...
              $statement = $pdo->prepare("SELECT
                  ...
                  LEFT JOIN tbl_end_category t2 ON t1.ecat_id = t2.ecat_id
					...
					LEFT JOIN tbl_top_category t4 ON t1.tcat_id = t4.tcat_id
					LEFT JOIN tbl_brands t5 ON t1.product_brand=t5.brand_id
                  WHERE t1.seller_id = :seller_id AND t1.p_is_approve = 0  -- Filter by seller_id and rejected products
                  ORDER BY t1.id DESC");
