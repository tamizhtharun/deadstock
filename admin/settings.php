...
if (isset($_POST['form4'])) {
    ...
    // Updating the database
    $statement = $pdo->prepare("UPDATE tbl_settings SET user_tc = ? WHERE id = 1");
    $statement->execute(array($user_tc));
...
if (isset($_POST['form5'])) { // Check if form5 is submitted
    ...
    $statement->execute(array($seller_tc));
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="running_text"
                                                style="height:140px;"><?php echo $running_text; ?></textarea>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="quote_span_text"
                                                value="<?php echo htmlspecialchars($quote_span_text); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="quote_text"
                                                rows="3"><?php echo htmlspecialchars($quote_text); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left"
                                                name="form_quote">Update Quote</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="tab_6">
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Seller Terms and Conditions</label>
                                        <div class="col-sm-4">
                                            <textarea type="text" class="form-control"
                                                name="seller_tc"><?php echo htmlspecialchars($seller_tc); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                    ...
                    <div class="tab-pane" id="tab_7">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Featured Product
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Latest Product
                                            Title<span>*</span></label>
                                        <div class="col-sm-8">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Popular Product
                                            Title<span>*</span></label>
                                        <div class="col-sm-8">
