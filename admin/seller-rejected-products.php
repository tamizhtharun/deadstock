                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            $statement = $pdo->prepare("SELECT s.seller_id, s.seller_name, s.seller_email, s.seller_address,
                                                          ...
                                                          COUNT(CASE WHEN p.p_is_approve = 0 THEN 0 END) AS rejected_product_count
                                                         FROM sellers s
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['rejected_product_count']; ?></td>
                                    <td>
                                        <a href="seller-rejected-product-view.php?seller_id=<?php echo $row['seller_id']; ?>">View Products</a>
                                    </td>
                                </tr>
                                <?php
                            }
