<style>
  .brand-logo {
    width: 161px;
    height: 160px;
    object-fit: contain; /* Changed from cover to contain for clarity */
    padding: 5px; /* Optional: Adds padding inside the border for spacing */
    background-color: #fff; /* Optional: Ensures a white background if images have transparency */
  }
.section-title{
  margin-top:-10px
}
