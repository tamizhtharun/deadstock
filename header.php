...
<head>
    ...
    <title><?php echo basename($_SERVER['PHP_SELF']) == 'product_landing.php' ? htmlspecialchars($p_name ?? '') . ' - Dead Stock Processing' : 'Dead Stock Processing'; ?></title>
    <link rel="icon" href="/deadstock/assets/uploads/<?php echo $favicon; ?>">
    ...
    <link rel="stylesheet" href="/deadstock/css/responsive.css">
    <link rel="stylesheet" href="/deadstock/css/header.css">
    ...
    <link rel="stylesheet" type="text/css" href="/deadstock/css/vendor.css">
    <link rel="stylesheet" type="text/css" href="/deadstock/css/style.css">
    <link rel="stylesheet" type="text/css" href="/deadstock/css/messages.css">
    <?php if (basename($_SERVER['PHP_SELF']) == 'product_landing.php'): ?>
        <link rel="stylesheet" href="/deadstock/css/product_landing.css">
    <?php endif; ?>
        <defs>
...
<!-- Notification Icon (Not shown in notification.php) -->
    ...
    <script src="/deadstock/js/messages.js"></script>
...
`;
    ...
    <script src="/deadstock/js/validation.js"></script>
