...
$whereConditions = ["o.seller_id = :seller_id", "o.order_type = 'direct'"];
            ...
            <div class="modern-table-container">
                ...
                <?php if(empty($result)): ?>
                    <div class="empty-state">
                        ...
                        <p>No direct orders match your search criteria.</p>
                    </div>
                <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function applyFilters() {
        ...
        window.location.href = 'direct-order.php' + (params.toString() ? '?' + params.toString() : '');
    }
