...
// Fetch recent bids (only status 1, 2, or 3)
$statement = $pdo->prepare("
    ...
    WHERE p.seller_id = ? 
    AND b.bid_status IN (1, 2, 3) -- Ensuring only valid statuses are fetched
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-3">
            <a href="bidding.php" style="text-decoration: none; color: inherit;">
        ...
        <div class="col-xl-3 col-lg-3">
            <a href="revenue.php" style="text-decoration: none; color: inherit;">
        ...
        <div class="col-xl-3 col-lg-3">
            <a href="bids_history.php" style="text-decoration: none; color: inherit;">
                <div class="card l-bg-cherry">
                    <div class="card-statistic-3 p-4">
                        <div class="card-icon card-icon-large">
        ...
        <div class="col-xl-3 col-lg-3">
            <a href="direct-order.php" style="text-decoration: none; color: inherit;">
                <div class="card l-bg-green-dark">
                    <div class="card-statistic-3 p-4">
                        <div class="card-icon card-icon-large">
