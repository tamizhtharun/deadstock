...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="end-category-add.php" class="add-new-btn">
	...
	<div class="row">
		<div class="col-md-12">
			...
			if (!empty($searchQuery)) {
				$whereConditions[] = "(t1.ecat_name LIKE :search OR t2.mcat_name LIKE :search OR t3.tcat_name LIKE :search)";
				...
				<?php else: ?>
					<table class="modern-table">
						...
						<tbody>
							...
							<tr>
								<td><?php echo $i; ?></td>
								<td><?php echo htmlspecialchars($row['ecat_name']); ?></td>
								<td><?php echo htmlspecialchars($row['mcat_name']); ?></td>
								<td><?php echo htmlspecialchars($row['tcat_name']); ?></td>
								<td>
									<a href="end-category-edit.php?id=<?php echo $row['ecat_id']; ?>" class="action-btn action-btn-primary">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	function applyFilters() {
		...
		window.location.href = 'end-category.php' + (params.toString() ? '?' + params.toString() : '');
	}
});
</script>
