...
<section class="py-5">
  <div class="container" style="margin-top: -30px;">
    ...
    <div class="row gx-5">
      ...
      <!-- Previous code remains the same until the product details section -->
<main class="col-lg-6">
  <dclass="ps-lg-3">
  ...
  <div id="priceRequestModal">
    ...
    <form id="priceRequestForm" method="POST" action="submit_bid.php">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="openRazorpayModal()" class="btn-rp btn-submit-rp">Pay and Place your
          Bid</button>
      </div>
    </form>
  </div>
